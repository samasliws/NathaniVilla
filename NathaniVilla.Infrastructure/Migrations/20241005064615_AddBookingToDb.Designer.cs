...
namespace NathaniVilla.Infrastructure.Migrations
{
    ...
    [Migration("20241005064615_AddBookingToDb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NathaniVilla.Domain.Entities.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("NathaniVilla.Domain.Entities.Booking", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("NathaniVilla.Domain.Entities.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("NathaniVilla.Domain.Entities.Booking", b =>
                {
                    b.HasOne("NathaniVilla.Domain.Entities.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
